...
-> Check if we can identify if this is eukaryote/viral/bacterial (idk what tool I'd use for this, will probably ask AI). If this is eukaryotic it is less likely to be highly dangerous.
...
-> Then I would probably run BLASTN (I assume this will be negative if the internal screening didn't bring up anything)

-> Reverse transcription to see if we can identify an known homologous protein sequences, if this can be linked to any known/dangerous sequences (BLASTx)
